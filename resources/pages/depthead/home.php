...
<head>
    ...
    <script defer src="resources/assets/javascript/face_logics/mtcnn-logic.js"></script>
...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <p style="font:80px; font-weight:400; color:#8d1c1c; text-align:center; padding-top:2px;">Please select course, subject, and room first. Before Launching Facial Recognition</p>
